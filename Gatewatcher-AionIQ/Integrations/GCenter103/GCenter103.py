...
def query_es_alerts(client: GwClient,
                    query: dict[str, Any]) -> list[dict[Any, Any]] | None:
...
def index_alerts_incidents(to_index: list[dict[Any, Any]] | None,
...
def index_metadata_incidents(to_index: list[dict[Any, Any]] | None,
...
def fetch_empty_selected_engines(client: GwClient,
    ...
    if max_fetch > 10000:
        ...
        gw_alerts = handle_little_fetch_empty_selected_engines(
            client=client,
            query=query,
            fetch_type=fetch_type
        )
